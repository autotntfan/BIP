...
% y=ax^2+bx+c 
% HoughTransform(a,b,c,UL,X)
% UL is the interval (UL-20,UL).UL(1) and UL(2) represent the UPPER limit for a and b direction respectively.
% ALERT:If X is NOT in the interval,the result is "points are noncollinear" definitely. 
...
function HoughTransform(a,b,c,UL,X)
x=-10:10;
%y=ax^2+bx+c 
figure(1);
y=a*x.^2+b.*x+c;
...
a_x=(UL(1)-20):0.01:UL(1);b_y=(UL(2)-20):0.01:UL(2); %坐標軸長度
